...
DRAM_ACC_LATENCY = 7000*CLOCK_PERIOD
WEIGHT_SRAM_LOAD_LATENCY = 6*CLOCK_PERIOD
ACTIVATION_SRAM_LOAD_LATENCY = 3*CLOCK_PERIOD
ACTIVATION_SRAM_WRITE_LATENCY = 3*CLOCK_PERIOD
COMPUTE_LATENCY = 2*CLOCK_PERIOD
